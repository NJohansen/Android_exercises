...
public class MainActivity extends AppCompatActivity {
    ...
    ContactRetriever contactsRetriever;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactsRecyclerView = findViewById(R.id.rc_view);
    ...
    private void loadContacts() {
        ...
        contactsRetriever = new ContactRetriever();
    ...
    class ContactRetriever extends AsyncTask<Void, Void, List<ContactPerson>>{
        @Override
        ...
        protected void onPostExecute(List<ContactPerson> contactPeople) {
            contactsRecyclerView.setAdapter(new ContactAdapter(contactPeople));
        }
    }
}
